...
//        .apply(path_headings);
    new com.datagraphice.fcriscuo.alsdb.graphdb.util.TsvRecordSplitIteratorSupplier(path_data, columnHeadings).get()
  ...
  public void accept(Path path) {
    com.datagraphice.fcriscuo.alsdb.graphdb.util.FrameworkPropertyService.INSTANCE.getOptionalPathProperty("PPI_INTACT_HEADINGS_FILE")
  ...
  public static void main(String[] args) {
    Stopwatch sw = Stopwatch.createStarted();
    com.datagraphice.fcriscuo.alsdb.graphdb.util.FrameworkPropertyService.INSTANCE.getOptionalPathProperty("TEST_PPI_INTACT_FILE")
        .ifPresent(path ->
