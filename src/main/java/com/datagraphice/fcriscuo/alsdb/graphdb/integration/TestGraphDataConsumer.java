package com.datagraphice.fcriscuo.alsdb.graphdb.integration;
...
import com.datagraphice.fcriscuo.alsdb.graphdb.supplier.GraphDatabaseServiceSupplier.RunMode;
 ...
 */
public class TestGraphDataConsumer implements BiConsumer<Path, com.datagraphice.fcriscuo.alsdb.graphdb.consumer.GraphDataConsumer> {
  ...
  @Override
  public void accept(Path path, com.datagraphice.fcriscuo.alsdb.graphdb.consumer.GraphDataConsumer graphDataConsumer) {
