...
public enum UniProtMappingService {
  ...
  class UniProtMapSupplier implements Supplier<ImmutableMap<String, UniProtMapping>> {
    ...
    private ImmutableMap<String, UniProtMapping> resolveMapFromFile() {
      ...
      new com.datagraphice.fcriscuo.alsdb.graphdb.util.TsvRecordStreamSupplier
          (Paths.get(com.datagraphice.fcriscuo.alsdb.graphdb.util.FrameworkPropertyService.INSTANCE.getStringProperty("ENSEMBL_UNIPROT_HGNC_FILE")))
          .get()
